...
class Details extends StatefulWidget {
 Details({Key key, this.student, this.dept, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => new _Details(student, dept, auth, logoutCallback, userId);
}
...
class _Details extends State<Details> {
  ...
  _Details(this.student,this.dept, this.auth, this.logoutCallback, this.userId);
