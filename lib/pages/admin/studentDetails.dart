...
class StudentDetails extends StatefulWidget {
 StudentDetails({Key key,this.email, this.dept, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  final String email, dept, userId;
  final BaseAuth auth;
  final VoidCallback logoutCallback;

  @override
  State<StatefulWidget> createState() => new _StudentDetails(email, dept, auth, logoutCallback, userId);
}

class _StudentDetails extends State<StudentDetails> {
  String dept, email, userId;
  BaseAuth auth;
  VoidCallback logoutCallback;

  _StudentDetails(this.email,this.dept, this.auth, this.logoutCallback, this.userId);
    ...
    call(databaseReference);
        ...
        @override
          ...
          var height = MediaQuery.of(context).size.height/4.5;
            ...
            return Scaffold(
               drawer: new AdminDrawerCodeOnly(
                 userId: this.userId,
                  auth : this.auth,
